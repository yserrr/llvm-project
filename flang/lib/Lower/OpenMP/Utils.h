...
/// Return the next DO construct nested in \p eval, skipping intervening code in
/// an imperfect loop nest, or null when there is none left to descend into
/// (e.g. the loop nest is shallower than required).
