...
; GFX6-NEXT:    v_mul_u32_u24_e32 v1, 7, v3
...
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_and_b32 s3, s2, 0xffffff
; GFX9-NEXT:    s_mul_hi_u32 s3, s3, 0xaaaaaab
; GFX9-NEXT:    s_mov_b32 s5, s0
; GFX9-NEXT:    s_lshl_b32 s4, s1, 8
; GFX9-NEXT:    s_lshl3_add_u32 s2, s3, s2
; GFX9-NEXT:    s_lshr_b32 s6, s0, 1
...
; GFX10-NEXT:    s_lshl_b32 s4, s1, 8
; GFX10-NEXT:    s_mul_hi_u32 s0, s0, 0xaaaaaab
; GFX10-NEXT:    s_lshr_b32 s3, s5, 1
; GFX10-NEXT:    s_lshl3_add_u32 s2, s0, s2
...
; GFX11-NEXT:    s_lshr_b32 s3, s5, 1
; GFX11-NEXT:    s_lshl3_add_u32 s2, s0, s2
...
; GFX9-NEXT:    v_lshl_add_u32 v2, v3, 3, v2
...
; GFX11-FAKE16-NEXT:    v_lshl_add_u32 v2, v3, 3, v2
...
; GFX8-NEXT:    v_lshlrev_b32_e32 v6, 3, v6
...
; GFX9-NEXT:    v_lshl_add_u32 v4, v6, 3, v4
; GFX9-NEXT:    v_mul_hi_u32 v6, v5, s4
; GFX9-NEXT:    v_not_b32_e32 v4, v4
; GFX9-NEXT:    v_lshrrev_b32_e32 v0, 1, v0
; GFX9-NEXT:    v_alignbit_b32 v0, v0, v2, v4
; GFX9-NEXT:    v_lshl_add_u32 v2, v6, 3, v5
; GFX9-NEXT:    v_lshlrev_b32_e32 v3, 8, v3
; GFX9-NEXT:    v_not_b32_e32 v2, v2
; GFX9-NEXT:    v_alignbit_b32 v3, v1, v3, 1
; GFX9-NEXT:    v_lshrrev_b32_e32 v1, 1, v1
...
; GFX10-NEXT:    v_lshlrev_b32_e32 v3, 8, v3
; GFX10-NEXT:    v_lshrrev_b32_e32 v8, 1, v0
; GFX10-NEXT:    v_mul_hi_u32 v6, 0xaaaaaab, v4
; GFX10-NEXT:    v_mul_hi_u32 v7, 0xaaaaaab, v5
; GFX10-NEXT:    v_alignbit_b32 v0, v0, v2, 1
; GFX10-NEXT:    v_lshl_add_u32 v4, v6, 3, v4
; GFX10-NEXT:    v_lshl_add_u32 v5, v7, 3, v5
; GFX10-NEXT:    v_lshrrev_b32_e32 v6, 1, v1
; GFX10-NEXT:    v_alignbit_b32 v1, v1, v3, 1
; GFX10-NEXT:    v_not_b32_e32 v2, v4
; GFX10-NEXT:    v_not_b32_e32 v3, v5
; GFX10-NEXT:    v_alignbit_b32 v0, v8, v0, v2
; GFX10-NEXT:    v_alignbit_b32 v1, v6, v1, v3
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-TRUE16-LABEL: v_fshl_v2i24:
; GFX11-TRUE16:       ; %bb.0:
; GFX11-TRUE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
...
; GFX11-TRUE16-NEXT:    v_lshrrev_b32_e32 v8, 1, v0
; GFX11-TRUE16-NEXT:    v_mul_hi_u32 v6, 0xaaaaaab, v4
; GFX11-TRUE16-NEXT:    v_mul_hi_u32 v7, 0xaaaaaab, v5
; GFX11-TRUE16-NEXT:    v_alignbit_b32 v0, v0, v2, 1
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX11-TRUE16-NEXT:    v_lshl_add_u32 v4, v6, 3, v4
; GFX11-TRUE16-NEXT:    v_lshl_add_u32 v5, v7, 3, v5
; GFX11-TRUE16-NEXT:    v_lshrrev_b32_e32 v6, 1, v1
; GFX11-TRUE16-NEXT:    v_alignbit_b32 v1, v1, v3, 1
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX11-TRUE16-NEXT:    v_not_b32_e32 v2, v4
; GFX11-TRUE16-NEXT:    v_not_b32_e32 v3, v5
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-TRUE16-NEXT:    v_alignbit_b32 v0, v8, v0, v2.l
; GFX11-TRUE16-NEXT:    v_alignbit_b32 v1, v6, v1, v3.l
; GFX11-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-FAKE16-LABEL: v_fshl_v2i24:
; GFX11-FAKE16:       ; %bb.0:
; GFX11-FAKE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
...
; GFX11-FAKE16-NEXT:    v_lshrrev_b32_e32 v8, 1, v0
; GFX11-FAKE16-NEXT:    v_mul_hi_u32 v6, 0xaaaaaab, v4
; GFX11-FAKE16-NEXT:    v_mul_hi_u32 v7, 0xaaaaaab, v5
; GFX11-FAKE16-NEXT:    v_alignbit_b32 v0, v0, v2, 1
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX11-FAKE16-NEXT:    v_lshl_add_u32 v4, v6, 3, v4
; GFX11-FAKE16-NEXT:    v_lshl_add_u32 v5, v7, 3, v5
; GFX11-FAKE16-NEXT:    v_lshrrev_b32_e32 v6, 1, v1
; GFX11-FAKE16-NEXT:    v_alignbit_b32 v1, v1, v3, 1
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX11-FAKE16-NEXT:    v_not_b32_e32 v2, v4
; GFX11-FAKE16-NEXT:    v_not_b32_e32 v3, v5
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-FAKE16-NEXT:    v_alignbit_b32 v0, v8, v0, v2
; GFX11-FAKE16-NEXT:    v_alignbit_b32 v1, v6, v1, v3
; GFX11-FAKE16-NEXT:    s_setpc_b64 s[30:31]
  %result = call <2 x i24> @llvm.fshl.v2i24(<2 x i24> %lhs, <2 x i24> %rhs, <2 x i24> %amt)
  ret <2 x i24> %result
}
