...
; RUN: llc -global-isel=1 -global-isel-abort=2 -mtriple=amdgcn-amd-amdpal -mcpu=gfx600 < %s | FileCheck -check-prefixes=GFX67,GFX6,GFX67-GISEL,GFX6-GISEL %s

; RUN: llc -global-isel=0 -mtriple=amdgcn-amd-amdpal -mcpu=gfx700 < %s | FileCheck -check-prefixes=GFX67,GFX7,GFX67-SDAG,GFX7-SDAG %s
; RUN: llc -global-isel=1 -global-isel-abort=2 -mtriple=amdgcn-amd-amdpal -mcpu=gfx700 < %s | FileCheck -check-prefixes=GFX67,GFX7,GFX67-GISEL,GFX7-GISEL %s
...
; RUN: llc -global-isel=1 -global-isel-abort=2 -mtriple=amdgcn-amd-amdpal -mcpu=gfx1100 -mattr=+real-true16 < %s | FileCheck -check-prefixes=GFX11,GFX11-GISEL,GFX11-GISEL-TRUE16 %s
; RUN: llc -global-isel=1 -global-isel-abort=2 -mtriple=amdgcn-amd-amdpal -mcpu=gfx1100 -mattr=-real-true16 < %s | FileCheck -check-prefixes=GFX11,GFX11-GISEL,GFX11-GISEL-FAKE16 %s
...
; RUN: llc -global-isel=1 -global-isel-abort=2 -mtriple=amdgcn-amd-amdpal -mcpu=gfx1200 -mattr=+real-true16 < %s | FileCheck -check-prefixes=GFX1200,GFX1200-GISEL,GFX1200-GISEL-TRUE16 %s
...
; GFX90A-GISEL-NEXT:    s_setpc_b64 s[30:31]
;
; GFX10-LABEL: clpeak_imad_pat_i64:
; GFX10:       ; %bb.0: ; %entry
; GFX10-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX10-NEXT:    v_add_co_u32 v4, vcc_lo, v0, 1
; GFX10-NEXT:    v_add_co_ci_u32_e64 v5, null, 0, v1, vcc_lo
; GFX10-NEXT:    v_mul_lo_u32 v7, v4, v3
; GFX10-NEXT:    v_mad_u64_u32 v[0:1], null, v4, v2, 0
; GFX10-NEXT:    v_mul_lo_u32 v6, v5, v2
; GFX10-NEXT:    v_add_co_u32 v4, vcc_lo, v0, v4
; GFX10-NEXT:    v_add3_u32 v1, v1, v7, v6
; GFX10-NEXT:    v_mul_lo_u32 v6, v4, v3
; GFX10-NEXT:    v_mad_u64_u32 v[3:4], null, v4, v2, 0
; GFX10-NEXT:    v_add_co_ci_u32_e64 v5, null, v1, v5, vcc_lo
; GFX10-NEXT:    v_mul_lo_u32 v2, v5, v2
; GFX10-NEXT:    v_add3_u32 v4, v4, v6, v2
; GFX10-NEXT:    v_mul_lo_u32 v2, v3, v1
; GFX10-NEXT:    v_mul_lo_u32 v5, v4, v0
; GFX10-NEXT:    v_mad_u64_u32 v[0:1], null, v3, v0, v[3:4]
; GFX10-NEXT:    v_add3_u32 v1, v5, v1, v2
; GFX10-NEXT:    v_mul_lo_u32 v2, v0, v4
; GFX10-NEXT:    v_mul_lo_u32 v4, v1, v3
; GFX10-NEXT:    v_mad_u64_u32 v[0:1], null, v0, v3, v[0:1]
; GFX10-NEXT:    v_add3_u32 v1, v4, v1, v2
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-LABEL: clpeak_imad_pat_i64:
; GFX11:       ; %bb.0: ; %entry
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    v_add_co_u32 v4, vcc_lo, v0, 1
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-NEXT:    v_add_co_ci_u32_e64 v5, null, 0, v1, vcc_lo
; GFX11-NEXT:    v_mul_lo_u32 v7, v4, v3
; GFX11-NEXT:    v_mad_u64_u32 v[0:1], null, v4, v2, 0
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_mul_lo_u32 v6, v5, v2
; GFX11-NEXT:    v_add3_u32 v1, v1, v7, v6
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_add_co_u32 v6, vcc_lo, v0, v4
; GFX11-NEXT:    v_add_co_ci_u32_e64 v5, null, v1, v5, vcc_lo
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_3)
; GFX11-NEXT:    v_mul_lo_u32 v7, v6, v3
; GFX11-NEXT:    v_mad_u64_u32 v[3:4], null, v6, v2, 0
; GFX11-NEXT:    v_mul_lo_u32 v2, v5, v2
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-NEXT:    v_mul_lo_u32 v1, v3, v1
; GFX11-NEXT:    v_add3_u32 v4, v4, v7, v2
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_mul_lo_u32 v2, v4, v0
; GFX11-NEXT:    v_mad_u64_u32 v[5:6], null, v3, v0, v[3:4]
; GFX11-NEXT:    v_add3_u32 v6, v2, v6, v1
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-NEXT:    v_mul_lo_u32 v2, v5, v4
; GFX11-NEXT:    v_mul_lo_u32 v4, v6, v3
; GFX11-NEXT:    v_mad_u64_u32 v[0:1], null, v5, v3, v[5:6]
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-NEXT:    v_add3_u32 v1, v4, v1, v2
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX90A-GISEL-NEXT:    s_setpc_b64 s[30:31]
;
; GFX10-LABEL: clpeak_imad_pat_v2i64:
; GFX10:       ; %bb.0: ; %entry
; GFX10-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX10-NEXT:    v_add_co_u32 v8, vcc_lo, v0, 1
; GFX10-NEXT:    v_add_co_ci_u32_e64 v9, null, 0, v1, vcc_lo
; GFX10-NEXT:    v_add_co_u32 v10, vcc_lo, v2, 1
; GFX10-NEXT:    v_add_co_ci_u32_e64 v11, null, 0, v3, vcc_lo
; GFX10-NEXT:    v_mul_lo_u32 v12, v9, v4
; GFX10-NEXT:    v_mul_lo_u32 v13, v8, v5
; GFX10-NEXT:    v_mad_u64_u32 v[0:1], null, v8, v4, 0
; GFX10-NEXT:    v_mul_lo_u32 v14, v11, v6
; GFX10-NEXT:    v_mul_lo_u32 v15, v10, v7
; GFX10-NEXT:    v_mad_u64_u32 v[2:3], null, v10, v6, 0
; GFX10-NEXT:    v_add3_u32 v12, v1, v13, v12
; GFX10-NEXT:    v_add_co_u32 v1, vcc_lo, v0, v8
; GFX10-NEXT:    v_add3_u32 v13, v3, v15, v14
; GFX10-NEXT:    v_add_co_ci_u32_e64 v3, null, v12, v9, vcc_lo
; GFX10-NEXT:    v_add_co_u32 v8, vcc_lo, v2, v10
; GFX10-NEXT:    v_add_co_ci_u32_e64 v9, null, v13, v11, vcc_lo
; GFX10-NEXT:    v_mul_lo_u32 v10, v3, v4
; GFX10-NEXT:    v_mul_lo_u32 v11, v1, v5
; GFX10-NEXT:    v_mul_lo_u32 v7, v8, v7
; GFX10-NEXT:    v_mul_lo_u32 v9, v9, v6
; GFX10-NEXT:    v_mad_u64_u32 v[5:6], null, v8, v6, 0
; GFX10-NEXT:    v_mad_u64_u32 v[3:4], null, v1, v4, 0
; GFX10-NEXT:    v_add3_u32 v6, v6, v7, v9
; GFX10-NEXT:    v_add3_u32 v4, v4, v11, v10
; GFX10-NEXT:    v_mul_lo_u32 v11, v3, v12
; GFX10-NEXT:    v_mul_lo_u32 v12, v5, v13
; GFX10-NEXT:    v_mul_lo_u32 v9, v6, v2
; GFX10-NEXT:    v_mul_lo_u32 v10, v4, v0
; GFX10-NEXT:    v_mad_u64_u32 v[0:1], null, v3, v0, v[3:4]
; GFX10-NEXT:    v_mad_u64_u32 v[7:8], null, v5, v2, v[5:6]
; GFX10-NEXT:    v_add3_u32 v1, v10, v1, v11
; GFX10-NEXT:    v_add3_u32 v8, v9, v8, v12
; GFX10-NEXT:    v_mul_lo_u32 v4, v0, v4
; GFX10-NEXT:    v_mul_lo_u32 v6, v7, v6
; GFX10-NEXT:    v_mul_lo_u32 v9, v1, v3
; GFX10-NEXT:    v_mad_u64_u32 v[0:1], null, v0, v3, v[0:1]
; GFX10-NEXT:    v_mul_lo_u32 v10, v8, v5
; GFX10-NEXT:    v_mad_u64_u32 v[2:3], null, v7, v5, v[7:8]
; GFX10-NEXT:    v_add3_u32 v1, v9, v1, v4
; GFX10-NEXT:    v_add3_u32 v3, v10, v3, v6
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-LABEL: clpeak_imad_pat_v2i64:
; GFX11:       ; %bb.0: ; %entry
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    v_add_co_u32 v8, vcc_lo, v0, 1
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_add_co_ci_u32_e64 v9, null, 0, v1, vcc_lo
; GFX11-NEXT:    v_add_co_u32 v10, vcc_lo, v2, 1
; GFX11-NEXT:    v_add_co_ci_u32_e64 v11, null, 0, v3, vcc_lo
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_2) | instid1(VALU_DEP_4)
; GFX11-NEXT:    v_mul_lo_u32 v12, v9, v4
; GFX11-NEXT:    v_mul_lo_u32 v13, v8, v5
; GFX11-NEXT:    v_mad_u64_u32 v[0:1], null, v8, v4, 0
; GFX11-NEXT:    v_mul_lo_u32 v14, v11, v6
; GFX11-NEXT:    v_mul_lo_u32 v15, v10, v7
; GFX11-NEXT:    v_mad_u64_u32 v[2:3], null, v10, v6, 0
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-NEXT:    v_add3_u32 v1, v1, v13, v12
; GFX11-NEXT:    v_add3_u32 v12, v3, v15, v14
; GFX11-NEXT:    v_add_co_u32 v3, vcc_lo, v0, v8
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_add_co_ci_u32_e64 v8, null, v1, v9, vcc_lo
; GFX11-NEXT:    v_add_co_u32 v9, vcc_lo, v2, v10
; GFX11-NEXT:    v_add_co_ci_u32_e64 v10, null, v12, v11, vcc_lo
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_4)
; GFX11-NEXT:    v_mul_lo_u32 v11, v8, v4
; GFX11-NEXT:    v_mul_lo_u32 v13, v3, v5
; GFX11-NEXT:    v_mul_lo_u32 v14, v9, v7
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_2) | instid1(VALU_DEP_2)
; GFX11-NEXT:    v_mul_lo_u32 v10, v10, v6
; GFX11-NEXT:    v_mad_u64_u32 v[7:8], null, v9, v6, 0
; GFX11-NEXT:    v_mad_u64_u32 v[5:6], null, v3, v4, 0
; GFX11-NEXT:    v_add3_u32 v8, v8, v14, v10
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-NEXT:    v_add3_u32 v6, v6, v13, v11
; GFX11-NEXT:    v_mul_lo_u32 v11, v8, v2
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_4) | instid1(VALU_DEP_4)
; GFX11-NEXT:    v_mul_lo_u32 v13, v6, v0
; GFX11-NEXT:    v_mad_u64_u32 v[3:4], null, v5, v0, v[5:6]
; GFX11-NEXT:    v_mul_lo_u32 v0, v5, v1
; GFX11-NEXT:    v_mul_lo_u32 v1, v7, v12
; GFX11-NEXT:    v_mad_u64_u32 v[9:10], null, v7, v2, v[7:8]
; GFX11-NEXT:    v_mul_lo_u32 v6, v3, v6
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX11-NEXT:    v_add3_u32 v4, v13, v4, v0
; GFX11-NEXT:    v_add3_u32 v10, v11, v10, v1
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX11-NEXT:    v_mul_lo_u32 v8, v9, v8
; GFX11-NEXT:    v_mul_lo_u32 v11, v4, v5
; GFX11-NEXT:    v_mad_u64_u32 v[0:1], null, v3, v5, v[3:4]
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_3)
; GFX11-NEXT:    v_mul_lo_u32 v4, v10, v7
; GFX11-NEXT:    v_mad_u64_u32 v[2:3], null, v9, v7, v[9:10]
; GFX11-NEXT:    v_add3_u32 v1, v11, v1, v6
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_2)
; GFX11-NEXT:    v_add3_u32 v3, v4, v3, v8
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
